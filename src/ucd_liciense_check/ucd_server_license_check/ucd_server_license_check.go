...
func main() {
	...
	var email string
	flag.StringVar(&email, "email", "ops@nxnus25.com", "<email@address>\temail address to receive alert")
	flag.StringVar(&email, "e", "ops@nxnus25.com", "<email@address> email address to receive alert")
	var path string
	...
	flag.StringVar(&smtpServer, "server", "google.com", "SMTP server name (hostname)")
	flag.StringVar(&smtpServer, "s", "google.com", "SMTP server name (hostname)")
	var smtpPort int
